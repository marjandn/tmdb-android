...
class GetFeaturedTvshows @Inject constructor(private val tvshowRepository: TvshowRepository): UseCase<List<Tvshow>, PagingParam>() {

    override suspend fun invoke(param: PagingParam): DataState<List<Tvshow>> = tvshowRepository.getFeaturedTvshows(pageParam = param)
}